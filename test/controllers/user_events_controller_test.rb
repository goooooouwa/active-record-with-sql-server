...
class UserEventsControllerTest < ActionController::TestCase
  ...
  test "should create user_event" do
    assert_difference('UserEvent.count') do
      post :create, user_event: { created_dt: @user_event.created_dt, event_id: @user_event.event_id, user_id: @user_event.user_id }
    end
  ...
  test "should update user_event" do
    patch :update, id: @user_event, user_event: { created_dt: @user_event.created_dt, event_id: @user_event.event_id, user_id: @user_event.user_id }
    assert_redirected_to user_event_path(assigns(:user_event))
  end
